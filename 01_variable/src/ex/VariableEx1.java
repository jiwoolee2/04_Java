...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * * Java는 JS와 다르게 
		 * 처음부터 변수으 ㅣ자료형을 지정해야된다!!!
		 * 
		 * * 1byte == 8bit
		 * -> 컴퓨터가 데이터 처리(연산)을 위한 최소 단위
		 * 
		 * [Java 기본 자료형 8가지] (꼭 외우기!!! 면접 물어봄)
		 * 
		 * - 논리형
		...
		// 2147483648 <- 일반 정수 표기법 == int 로 인식
		// 2147483648L or 2147483648l 표기 == long으로 인식된다!!
		long longNum1 = 2147483648L;
		long longNum2 = 30_030_303_030l; //_ : 출력 x, 연산시 인식 x
		
		System.out.println("intNum1 : "+intNum1);
		System.out.println("longNum1 : "+longNum1);
		System.out.println("longNum2 : "+longNum2);
		// -> 출력 결과에 리터럴 표기법 L,l 포함 X
		// -> 코드 상에서만 리터럴을 사용해 자료형 구분
		 ...
		 * - 리터럴 표기법 : ""
		 * 
		 * - String은 몇 글자가 작성될 지 모르기 때문에
		 * 기본적으로 크기가 정해져있는 "기본자료형"에 포함XX
		 * 
