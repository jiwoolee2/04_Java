...
public class BasicRun {
	...
	public static void main(String[] args) {
		...
		// Car 객체 생성 -> Car 클래스에 작성된 내용을 토대로 Heap메모리 영역에 생성
		Car myCar = new Car();
		...
		// myCar가 참조한느 Car 객체의 필드 값 얻어오기
		System.out.println("myCar brnad : "+myCar.brand);
		...
		// Car 클래스 재사용
		Car myCar2 = new Car(); // Heap메모리 영역에 Car클래스를 이용해 객체를 생성하겠다는 말
