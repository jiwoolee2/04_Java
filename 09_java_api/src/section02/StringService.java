...
public class StringService {
	 ...
	 *   ex) String s1 = "hello";
	 * 	 -> heap 메모리 영역에 존재하는 String Constant(상수) Pool(웅덩이)
	 * 			에 String 객체 생성
	 * 
	 * 2) new 연산자를 이용하여 생성
	 ...
	 * -> 같은 값을 가지는 서로 다른 객체가 같은 주소를 참조하게 됨
	 */
	...
	public void test3() {
		...
		/* delete(int,start,int end) : start ~ end 미만 사이 삭제 */
		sb.delete(4, 9);
		System.out.println("----------------------------");
		System.out.println("sb.toString() : " + sb.toString());
		System.out.println("sb 크기 :" + sb.capacity());
