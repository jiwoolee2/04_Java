...
public class WrapperService {
	 ...
	 * 
	 * *** 중요 ***
	 * - Java에서는 Boxing, Unboxing을 자동으로 수행되도록
	 * 	 구현되어 있음 (jdk 11부터 강제)
	...
	public void test1() {
		...
		// Object를 전달 받는(즉, 모든 객체를 전달 받는) 메서드
	...
	public void printValue2(Object obj) {
		...
		int num2 = wrap; // Integer -> int 로 Auto Unboxing
	}
	...
	public void test3() {
		...
		System.out.println("int는 최댓값 " + Integer.MAX_VALUE);
		System.out.println("int는 최솟값 " + Integer.MIN_VALUE);
		
		System.out.println("---------------------------------");
		
		System.out.println("double는 몇 바이트? " + Double.BYTES);
		System.out.println("double는 몇 비트? " + Double.SIZE);
		System.out.println("double는 최댓값 " + Double.MAX_VALUE);
		System.out.println("double는 최솟값 " + Double.MIN_VALUE);
		...
		double d = Double.parseDouble("3.14159265358979");
...
//		String s1 = num1;  // 오류(자료형 불일치)
		...
		// 결국 int가 Integer가되고 Integer가 String이 되는 듯?
		int num2 = 700;
