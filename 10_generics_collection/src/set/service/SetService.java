...
public class SetService {
	 ...
	 * - 중복 데이터(객체) 저장 X
	 *  -> 중복된 객체가 들어오면 덮어쓰기
	 *  -> *중요* equals(), hashCode() 오버라이딩 필수(동등 비교를 위해)
	 * 
	 * Set 인터페이스를 구현한 구현체
	 * 
	 * 1. HashSet : 처리 속다가 빠른 Set (제일 많이 사용)
	 * 
	...
	/**
	 *  Hash 단어가 포함된  컬렉션은 무조건 equals(), hasCode()
	 *  가 오버라이딩 되어있어야 한다!
	 *  
	 *  
	 *  @@@ Object가 제공되는 매서드 오버라이딩 목적 @@@
	 *  
	 ...
	 * 
	 * 2) E next() : 다음 요소를 반환 -> 무조건 hasNext이후에 사용
	 * 
	 */
	public void test3() {
	 ...
	 *  
	 *  ** 선행 조건 **
	 *  저장되는 객체가 Coparable 인ㅌ페이스를 상속 받아서 구현
